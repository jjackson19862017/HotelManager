...
@section('scripts')
    ...
    @section('content')
        ...
        <div class="container-fluid mt-1">
                ...
                <div class="card mb-1 w-100">
                    ...
                    <div class="card-header bg-dark text-white h4">
                        {{$staff->FullName}} <small>based at {{$staff->hotel->name}} on
                            a {{strtolower($staff->employmenttype)}} rate.</small>
                    </div>
                    <!--/ Card Header -->
                    <div class="card-body">
                        @if ($errors->any())
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="WeekCommencing" id="WeekCommencing">
                                                <option value={{$Thisrota->weekcommencing}}>{{date('jS F Y', strtotime($Thisrota->weekcommencing))}}
                                                @foreach ($AvailableDates as $item)
                                                    <option value={{$item}}>{{date('jS F Y', strtotime($item))}} @if($loop->first)
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number"
                                                   ...
                                                   placeholder="Enter Holidays Taken" value="{{$Thisrota->holidaydays}}">
                                            @error('holidays')
                                            <div class="invalid-feedback">{{$message}}</div>
                                            @enderror
                                        </div>
                    ...
                    <div class="card w-100 mb-1">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="{{$day}}RoleOne" class="col-form-label col-sm-3">1st Role</label>
                                        <div class="col-sm-9">
                                            <select class="form-control" name="{{$day}}RoleOne" id="{{$day}}RoleOne"
                                                ...
                                                <option value="{{$Thisrota->getRawOriginal($day.'roleone')}}">{{$Thisrota->$day.roleone}}</option>
                                    ...
                                    <div class="form-group row">
                                        <label for="{{$day}}StartOne" class="col-form-label col-sm-3" id="{{$day}}S1">1st
                                            Start</label>
                                        <div class="col-sm-9">
                                            <input type="time"
                                    ...
                                    <div class="form-group row">
                                        <label for="{{$day}}FinishOne" class="col-form-label col-sm-3" id="{{$day}}S2">1st
                                            Finish</label>
                                        <div class="col-sm-9">
                                            <input type="time"
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="form-group row">
                                        <label for="{{$day}}RoleTwo" class="col-form-label col-sm-3" id="{{$day}}R2">2nd
                                            Role</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="{{$day}}StartTwo" class="col-form-label col-sm-3" id="{{$day}}S3">2nd
                                            Start</label>
                                        <div class="col-sm-9">
                                            <input type="time"
                                    ...
                                    <div class="form-group row">
                                        <label for="{{$day}}FinishTwo" class="col-form-label col-sm-3" id="{{$day}}S4">2nd
                                            Finish</label>
                                        <div class="col-sm-9">
                                            <input type="time"
            ...
            <button type="submit" class="btn btn-primary float-right">Insert {{$staff->forename}}'s Rota</button>
            </form>
            <!--/ Row -->
        </div>
        <!--/ Container -->
    ...
    @section('js')
        <script>
            ...
            $(document).ready(function () {
                ...
                console.log(DayRoleOne);
                console.log(DayRoleTwo);
