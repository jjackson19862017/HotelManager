                    ...
                    <div class="card-body border border-dark">
                        ...
                        <form action="{{route('endofday.update',$sales->id)}}" method="POST" class="form-horizontal">
                            ...
                            <input type="hidden"
                                   ...
                                   value="{{$sales->hotel_id}}">
                            <input type="hidden"
                                   class="form-control text-right"
                                   name="totalrooms"
                                   id="totalrooms" aria-describedby="helpId"
                                   value="{{$sales->totalrooms}}">
                            <div class="row">
                                <div class="col-sm-12 col-md-4">
                                    <div class="card border border-dark mb-4">
                                        <div class="card-header bg-dark text-white">Other Payment Forms</div>
                                        <div class="card-body">
                                            <table class="table table-sm table-borderless">
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td><input type="number" id="miscresult" disabled="disabled"
                                                               class="form-control text-right" value="{{$OtherPaymentTotals}}"></td>
                                                </tr>
                                                </tfoot>
                                            </table>
                                        </div>
                                    ...
                                    <div class="card border border-dark mb-4">
                                        <div class="card-header bg-dark text-white">Card Machines</div>
                                        <div class="card-body">
                                            <table class="table table-sm table-borderless">
                                                <tbody>
                                                <tr>
                                                    <td><label for="pdqreception"
                                                               class="col-form-label">Reception</label>
                                                    </td>
                                                    <td><input type="number"
                                                ...
                                                <tr>
                                                    <td><label for="pdqrestaurant"
                                                               class="col-form-label">Restaurant</label>
                                                    </td>
                                                    <td><input type="number"
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td><input type="number" id="result" disabled="disabled"
                                                               class="form-control text-right" value="{{$sales->cardtotal}}"></td>
                                                </tr>
                                                </tfoot>
                                            </table>
                                        </div>
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="card border border-dark mb-4">
                                        <div class="card-header bg-dark text-white">Till Counting</div>
                                        <div class="card-body">
                                            ...
                                            <table class="table table-sm table-borderless">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="number" id="totalnotesfifty" disabled="disabled"
                                                               class="form-control text-right" value="{{$sales->totalnotefifty}}"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" id="totalnotestwenty" disabled="disabled"
                                                               class="form-control text-right" value="{{$sales->totalnotetwenty}}"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" id="totalnotesten" disabled="disabled"
                                                               class="form-control text-right" value="{{$sales->totalnoteten}}"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" id="totalnotesfive" disabled="disabled"
                                                               class="form-control text-right" value="{{$sales->totalnotefive}}"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" id="totalcoinsonepound" disabled="disabled"
                                                               class="form-control text-right" value="{{$sales->totalcoinonepound}}"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" id="totalcoinsfifty" disabled="disabled"
                                                               class="form-control text-right" value="{{$sales->totalcoinfifty}}"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" id="totalcoinstwenty" disabled="disabled"
                                                               class="form-control text-right" value="{{$sales->totalcointwenty}}"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" id="totalcoinsten" disabled="disabled"
                                                               class="form-control text-right" value="{{$sales->totalcointen}}"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" id="totalcoinsfive" disabled="disabled"
                                                               class="form-control text-right" value="{{$sales->totalcoinfive}}"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" id="totalcoinstwo" disabled="disabled"
                                                               class="form-control text-right" value="{{$sales->totalcointwo}}"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" id="totalcoinsone" disabled="disabled"
                                                               class="form-control text-right" value="{{$sales->totalcoinone}}"></td>
                                                </tr>
                                                </tbody>
                                                <tfoot>
                                                <tr>
                                                    <td></td>
                                                    <td>Total Cash -</td>
                                                    <td><input type="number" id="totalcash" disabled="disabled"
                                                               class="form-control text-right" value="{{$sales->cashtotal}}"></td>
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="card border border-dark mb-4">
                                        <div class="card-header bg-dark text-white">Payment Totals</div>
                                        <div class="card-body">
                                            <table class="table table-sm table-borderless">
                                                <tbody>
                                                <tr>
                                                    <td>Total Cash and Cards</td>
                                                    <td><input type="number" id="candc" disabled="disabled"
                                                               class="form-control text-right" value="{{$CCPT}}"></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>Float</td>
                                                    <td><input type="number" id="tillfloat" disabled="disabled"
                                                               class="form-control text-right" value="{{$sales->float}}"></td>
                                                </tr>
                                                <tr>
                                                    <td>Cash for Safe</td>
                                                    <td><input type="number" id="cashforsafe" disabled="disabled"
                                                               class="form-control text-right" value="{{$sales->cashsafe}}"></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="card border border-dark mb-4">
                                        <div class="card-header bg-dark text-white">Room Details</div>
                                        <div class="card-body">
                                            ...
                                            <table class="table table-sm table-borderless">
                                                ...
                                                <tr>
                                                    <td><label for="roomsoccupied"
                                                               class="col-form-label">Occupied</label>
                                                    </td>
                                                    <td><input type="number"
                                                ...
                                                <tr>
                                                    <td><label for="residents" class="col-form-label">Residents</label>
                                                    </td>
                                                    <td><input type="number"
                                    ...
                                    <button type="submit" class="btn btn-success btn-block">Update End of Day</button>
